...
/**
 * Implementation specific tests for {@link Employer}.
 *
 * @author Christian Otto
 */
public class EmployerImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = EmployerImpl.class;
