...
/**
 * Implementation specific tests for {@link BookingReferenceType}.
 *
 * @author Christian Otto
 */
public class BookingReferenceTypeImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = BookingReferenceTypeImpl.class;
    ...
    return ( BookingReferenceTypeImpl ) instance;
  }
}
