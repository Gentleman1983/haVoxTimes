...
/**
 * Implementation specific tests for {@link Worker}.
 * 
 * @author Christian Otto
 */
public class WorkerImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = WorkerImpl.class;
