...
/**
 * Implementation specific tests for {@link BookingReference}.
 *
 * @author Christian Otto
 */
public class BookingReferenceImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = BookingReferenceImpl.class;
    ...
    return ( BookingReferenceImpl ) instance;
  }
}
