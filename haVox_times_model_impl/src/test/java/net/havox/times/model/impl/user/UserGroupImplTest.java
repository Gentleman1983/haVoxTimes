...
/**
 * Implementation specific tests for {@link UserGroup}.
 *
 * @author Christian Otto
 */
public class UserGroupImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = UserGroupImpl.class;
