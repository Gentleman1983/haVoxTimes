...
/**
 * Implementation specific tests for {@link Booking}.
 * 
 * @author Christian Otto
 */
public class BookingImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = BookingImpl.class;
