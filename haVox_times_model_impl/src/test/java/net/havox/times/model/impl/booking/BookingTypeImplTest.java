...
/**
 * Implementation specific tests for {@link BookingType}.
 *
 * @author Christian Otto
 */
public class BookingTypeImplTest extends AbstractChangeAwareClassTest
{

  @Override
  public AbstractChangeAwareClass createNewInstance( Long id, long version ) throws Exception
  {
    Class<?> clazz = BookingTypeImpl.class;
    ...
    return ( BookingTypeImpl ) instance;
  }
}
