 ...
 */
package net.havox.contacts.model.factory;

import net.havox.contacts.model.api.Address;
import net.havox.contacts.model.api.City;
import net.havox.contacts.model.api.Company;
import net.havox.contacts.model.api.Country;
import net.havox.contacts.model.api.Person;
import net.havox.contacts.model.impl.AddressImpl;
import net.havox.contacts.model.impl.CityImpl;
import net.havox.contacts.model.impl.CompanyImpl;
import net.havox.contacts.model.impl.CountryImpl;
import net.havox.contacts.model.impl.PersonImpl;
