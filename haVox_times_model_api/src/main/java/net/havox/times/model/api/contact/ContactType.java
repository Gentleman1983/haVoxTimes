...
public enum ContactType
{
  ...
  protected static class ValidationRegularExpressions
  {
    ...
    public static final String FACEBOOK_REGEX = "^[A-Za-z0-9\\.\\-_]+";
    public static final String ICQ_REGEX = "^\\d+";
    public static final String INSTAGRAM_REGEX = "^[A-Za-z0-9\\._]+";
    public static final String PHONE_REGEX = "^(\\+[0-9]{1,5}[ ]?)?(\\([0-9][0-9-/ ]*[0-9]\\)[ ]?)?[0-9][0-9-/ ]*[0-9]";
    public static final String SKYPE_REGEX = "[a-zA-Z][a-zA-Z0-9\\.,\\-_]{5,31}";
    public static final String TWITTER_USER_REGEX = "^[A-Za-z0-9_]{1,15}$";
    public static final String URL_REGEX = "^(ftp|http(s?))://((\\S+:)?\\S+@)?([a-zA-Z0-9][a-zA-Z0-9_\\-\\.]*[a-zA-Z0-9](:\\d{1,5})?)(/([a-zA-Z0-9_/\\&\\?\\=\\-\\.\\~\\%\\(\\)#]*))?";
    public static final String XING_REGEX = "^.+"; // Currently no specifications known.
  }
}
